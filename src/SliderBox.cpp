...
SliderBox::SliderBox(int x, int y, int width, int height,
...
void SliderBox::resize(int x, int y, int width, int height)
{
    this->x = x;
    this->y = y;
    this->width = width;
...
void SliderBox::processMouseEvent(QMouseEvent *e)
{
    for(int i = 0; i < this->items.size(); i++)
    {
